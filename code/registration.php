...
$check=mysqli_query($con,"select count(*) from roomdetail where room_type='$roomtype'") 
...
mysqli_query($con,"INSERT INTO roomdetail (username,checkin_date,checkout_date,room_type,no_of_room,amount) VALUES('$username','$startdate','$enddate','$roomtype','$room_nos','$amount')") 
